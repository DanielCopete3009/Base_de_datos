...
-- 1. Mostrar todas las columnas de la tabla corredores
-- Primero usamos la base de datos
USE MARATOON;
SELECT * FROM corredores;

 -- Ejemplo 02 - Espcificación de una lista de columnas -- Muestra de la tabla corredor sólo las columnas especificadas en la lista 
